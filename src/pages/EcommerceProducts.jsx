...
const products = [
  ...
  { id: 2, name: 'Apple Watch Series 5 Edition GPS + Cellular', number: '#790841', category: 'Watch', date: '12.09.20', price: '', status: 'Available', selected: true },
  { id: 3, name: 'Apple iPhone 11 Pro Max 256GB Space Gray', number: '#790841', category: 'Phone', date: '12.09.20', price: '$2.500', status: 'Available', selected: true },
  { id: 4, name: 'Apple Watch Series 5 Edition GPS + Cellular', number: '#790841', category: 'Watch', date: '12.09.20', price: '', status: 'Available', selected: true },
...
function ProductsTable({ products: visibleProducts, query, page, onQueryChange, onPageChange }) {
  return (
    <section className="w-full max-w-[1110px] rounded-xl2 border border-ink-100 bg-white p-5 shadow-card xl:h-[729px]">
